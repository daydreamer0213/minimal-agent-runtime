...
class WebTests(unittest.TestCase):
    ...
    def test_static_files_are_whitelisted_and_reject_queries(self):
        ...
        self.assertIn("function ensureStatePayload(payload, actionLabel)", script_text)
        self.assertIn("payload.state", script_text)
        ...
        self.assertIn("@media (max-width: 1199px) and (min-width: 769px)", css)
